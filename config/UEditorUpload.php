...
*/
    'core' => [
        ...
        'qiniu'=>[
            'accessKey'=>___accessKey,
            'secretKey'=>___secretKey,
            'bucket'=>'laigaonew',
            'url'=>'http://odxq81dcn.bkt.clouddn.com/',//七牛分配的CDN域名,注意带上http://
    ...
    'upload' => [
        ...
        "imageUrlPrefix" => ___host, /* 图片访问路径前缀,和七牛有冲突（使用七牛的时候，这里置空） */
